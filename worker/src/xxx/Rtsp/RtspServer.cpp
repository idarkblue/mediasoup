...
int RtspServer::OnRecvDescribe(RtspRemoteRequest &request)
{
    ...
    std::string sdp = this->Transform2Sdp(ctx, publisher->GetProducerParameters());
    if (sdp.empty()) {
...
std::string RtspServer::Transform2Sdp(RtspServer::Context *ctx, std::vector<pingos::ProducerParameters> &parameters)
{
