    ...
    while (true)
    {
        ...
        if (nsRet != 0)
        {
            switch (nsRet)
            {
                ...
                {
                    PMS_ERROR("NETSTRING_ERROR_TOO_LONG");
                ...
                {
                    PMS_ERROR("NETSTRING_ERROR_NO_COLON");
                ...
                {
                    PMS_ERROR("NETSTRING_ERROR_NO_COMMA");
                ...
                {
                    PMS_ERROR("NETSTRING_ERROR_LEADING_ZERO");
                ...
                {
                    PMS_ERROR("NETSTRING_ERROR_NO_LENGTH");
