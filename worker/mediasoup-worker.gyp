  ...
  [
    ...
    },
    {
      ...
      [
        ...
        'pingos/master.cpp',
        'pingos/worker.cpp',
        'pingos/master/RtcMaster.cpp',
        'pingos/master/RtcWorker.cpp',
        'pingos/process/MainProcess.cpp',
        'pingos/process/SubProcess.cpp',
        'pingos/process/Pipe.cpp',
        'pingos/process/UnixStreamSocket.cpp',
        'pingos/logger/Log.cpp',
        'pingos/core/Configuration.cpp',
        'pingos/core/ConsoleFilter.cpp',
        'pingos/core/ConsoleRequest.cpp',
        'pingos/core/Loop.cpp',
        'pingos/core/Module.cpp',
        'pingos/core/Session.cpp',
        'pingos/core/Stream.cpp',
        'pingos/core/ConsoleChannel.cpp',
        # 'pingos/modules/ConsoleModule.cpp',
        # 'pingos/modules/WebRtcModule.cpp',
        'pingos/network/NetConnection.cpp',
